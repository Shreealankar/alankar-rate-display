...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'start_voice_search': 'Start Voice Search',
    'stop_listening': 'Stop Listening',
    'listening': 'Listening...',
    'voice_not_supported': 'Voice Not Supported',
    'voice_not_supported_desc': 'Your browser doesn\'t support voice recognition.',
    'voice_search_complete': 'Voice Search Complete',
    'searched_for': 'Searched for',
    'voice_search_error': 'Voice Search Error',
    'voice_search_error_desc': 'There was an error with voice recognition. Please try again.',
    'ai_assistant': 'AI Assistant',
    'ai_welcome_message': 'Hello! I can help you with jewelry questions, gold rates, and shopping advice.',
    'ai_input_placeholder': 'Ask me about jewelry, rates, or our shop...',
    'ai_error': 'AI Error',
    'ai_error_desc': 'There was an error with the AI assistant. Please try again.',
    'ai_error_message': 'Sorry, I encountered an error. Please try again.',
    'voice_rate_inquiry': 'Voice Rate Inquiry',
    'voice_rate_description': 'Listen to today\'s gold and silver rates spoken aloud.',
    'hear_rates': 'Hear Today\'s Rates',
    'stop_speaking': 'Stop Speaking',
    'speaking_rates': 'Speaking rates...',
    'voice_error': 'Voice Error',
    'voice_error_desc': 'There was an error with voice playback. Please try again.',
    'what_can_i_help_you_with': 'What can I help you with?',
    'simple_interface_description': 'Choose what you need help with by touching the icons above.',
    'need_help': 'Need Help?',
    ...
    'jewelry_gallery': 'Jewelry Gallery',
  },
  mr: {
    // Common
    ...
    // AI Features
    'voice_search': 'आवाज शोध',
    'start_voice_search': 'आवाज शोध सुरू करा',
    'stop_listening': 'ऐकणे बंद करा',
    'listening': 'ऐकत आहे...',
    'voice_not_supported': 'आवाज समर्थित नाही',
    'voice_not_supported_desc': 'तुमचा ब्राउझर आवाज ओळखण्यास समर्थन देत नाही.',
    'voice_search_complete': 'आवाज शोध पूर्ण',
    'searched_for': 'शोधले',
    'voice_search_error': 'आवाज शोध त्रुटी',
    'voice_search_error_desc': 'आवाज ओळखण्यात त्रुटी आली. कृपया पुन्हा प्रयत्न करा.',
    'ai_assistant': 'एआय सहायक',
    'ai_welcome_message': 'नमस्कार! मी दागिन्यांच्या प्रश्नांबद्दल, सोन्याच्या दरांबद्दल आणि खरेदीच्या सल्ल्यांबद्दल मदत करू शकतो.',
    'ai_input_placeholder': 'दागिने, दर किंवा आमच्या दुकानाबद्दल विचारा...',
    'ai_error': 'एआय त्रुटी',
    'ai_error_desc': 'एआय सहायकामध्ये त्रुटी आली. कृपया पुन्हा प्रयत्न करा.',
    'ai_error_message': 'माफ करा, मला त्रुटी आली. कृपया पुन्हा प्रयत्न करा.',
    'voice_rate_inquiry': 'आवाज दर चौकशी',
    'voice_rate_description': 'आजचे सोने आणि चांदीचे दर बोलून ऐका.',
    'hear_rates': 'आजचे दर ऐका',
    'stop_speaking': 'बोलणे बंद करा',
    'speaking_rates': 'दर बोलत आहे...',
    'voice_error': 'आवाज त्रुटी',
    'voice_error_desc': 'आवाज प्लेबॅकमध्ये त्रुटी आली. कृपया पुन्हा प्रयत्न करा.',
    'what_can_i_help_you_with': 'मी तुम्हाला कशात मदत करू शकतो?',
    'simple_interface_description': 'वरील चिन्हांना स्पर्श करून तुम्हाला कोणत्या गोष्टीत मदत हवी आहे ते निवडा.',
    'need_help': 'मदत हवी आहे?',
    'contact_us': 'आमच्याशी संपर्क साधा',
    'location': 'स्थान',
    'shop_hours': 'दुकान वेळा',
    'gold_rates': 'सोन्याचे दर',
    'necklace': 'हार',
    'ring': 'अंगठी',
    'earring': 'कानातले',
    'bracelet': 'बांगडी',
    'pendant': 'लटकन',
    'clear': 'साफ करा',
    'search_jewelry': 'दागिने शोधा...',
    'jewelry_gallery': 'दागिने गॅलरी',
  }
};

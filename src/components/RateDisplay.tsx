...
export const RateDisplay = () => {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      ...
      {isLocked ? (
        <div className="text-center p-4 sm:p-8 bg-amber-50 dark:bg-amber-950 rounded-lg border-2 border-amber-500">
          <div className="flex justify-center mb-4">
            <div className="relative">
              <svg className="w-12 h-12 sm:w-16 sm:h-16 text-amber-600 dark:text-amber-400" fill="currentColor" viewBox="0 0 24 24">
          ...
          <h3 className="text-base sm:text-xl font-bold text-amber-900 dark:text-amber-100 mb-3 px-2">
            {t('home.rateLocked')}
          </h3>
          <div className="flex justify-center">
            <Button 
              onClick={handleWhatsAppClick}
              className="mt-4 bg-green-600 hover:bg-green-700 text-white font-semibold px-4 sm:px-6 py-2 sm:py-3 rounded-lg inline-flex items-center justify-center gap-2 shadow-lg text-sm sm:text-base"
            >
              ...
              <span className="whitespace-nowrap">{t('home.askOnWhatsApp')}</span>
            </Button>
          </div>
        </div>
      ) : error ? (
